// Auto-mirrored from the Python backend STATIC_KOSPI200_POOL (main.py).
// Regenerate when the backend pool changes. KOSPI200 constituents are KOSPI-listed.
export type PoolEntry = { code: string; name: string; market: "KOSPI" | "KOSDAQ" };

export const KOSPI200_POOL: PoolEntry[] = [
